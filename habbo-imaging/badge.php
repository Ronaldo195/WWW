...
imagegif($im);
$badgedata = $_GET['badge'];
if(file_exists("badge.php?badge=$badgedata.gif")) {
imagedestroy($im);
} else {
imagegif($im , "badge.php?badge=$badgedata.gif");
imagedestroy($im);
}
?> 